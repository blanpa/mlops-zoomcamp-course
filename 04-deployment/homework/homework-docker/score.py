...
def save_results(df, y_pred, run_id, output_file, year: str, month: str):
...
def apply_model(input_file, run_id, output_file, year, month):
    ...
    save_results(df, y_pred, run_id, output_file, year, month)
    return output_file
...
def run():
    ...
    #run_id = sys.argv[4] # '8bb01fbcd9ab42ae9ba041b3d28788ad'


    print(taxi_type, year, month, run_id)
